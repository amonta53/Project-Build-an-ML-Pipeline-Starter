...
def test_row_count(data) -> None:
    """
    Test the size of the dataset to ensure it falls within expected bounds, indicating a reasonable number of entries.
...
def test_price_range(data, min_price, max_price):
    """
    Test the price range to ensure it falls within expected min and max price range.
